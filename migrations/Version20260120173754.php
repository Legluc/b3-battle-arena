 ...
 */
final class Version20260120173754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rencontre (id INT AUTO_INCREMENT NOT NULL, joueur1_id INT NOT NULL, joueur2_id INT NOT NULL, gagnant_id INT DEFAULT NULL, pdf_link VARCHAR(255) NOT NULL, INDEX IDX_460C35ED92C1E237 (joueur1_id), INDEX IDX_460C35ED80744DD9 (joueur2_id), INDEX IDX_460C35ED2F942B8 (gagnant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
